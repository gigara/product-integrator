...
REM ---------------------------------------------------------------------------
REM ---------------------------------------------------------------------------
REM Copyright (c) 2026, WSO2 LLC. (https://www.wso2.com)
REM
...
:checkServer
rem We need to set BALLERINA_HOME for the classpath construction
set "BALLERINA_HOME=%~dp0.."
